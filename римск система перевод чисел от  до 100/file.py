...
# создаем массив верных римских,с удобными,,считабельными,,индексами(поэтому 1эл левый)
ch = [0, 'I', 'II', 'III', 'IV', 'V', 'VI', 'VII', 'VIII', 'IX', 'X', 'L', 'C']
alert = 0  # переменная вывода
# ищем длину числа минус один дабы сделаать поиск по индексам(j)
N = len(str(a))-1
